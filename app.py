...
st.write("DEBUG - Key loaded:", bool(google_api_key))
...
# %%
llm = ChatGoogleGenerativeAI(model='gemini-3.5-flash-lite', google_api_key=google_api_key, safety_settings=safety_settings)
